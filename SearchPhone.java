...
public class SearchPhone extends JFrame implements ActionListener
{
	...
	JTable table;
	Object data[][];
	final String[] colHeads = {"Entry ID" , "Name" , "Phone No."};
    String str;
    JPanel panel5;

	public SearchPhone(String fname)
	{
		super(fname);
		...
		panel1.add(new JLabel("Event Inc."));
		panel2.add(new JLabel(" Phone Details Form"));
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{	
			...
			SearchPhoneNo SA = new SearchPhoneNo("Phone Search Form",str);
  		    SA.setSize(600,300);
