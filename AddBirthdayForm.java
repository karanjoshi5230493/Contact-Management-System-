...
//AddBirthdayForm class adds a new birthday date entry.
public class AddBirthdayForm extends JFrame implements ActionListener
{
  ...
  public AddBirthdayForm(String fname)
  {
    super(fname);
    ...
    panel1.add(new JLabel("Birthday Entry Form"));
    ...
    panel3.add(new JLabel("Enter Date of Birth : "));
  ...
  public void actionPerformed(ActionEvent ae)
  {
	  ...
	  if(ae.getSource()==cmd_Add)
	  {
		  ...
		  if(checkValues()==true)
		  {
			  ...
			  try
			  {
				  //Open Birthday file to append a new entry.
				  BufferedWriter br=new BufferedWriter(new FileWriter("Birthday",true));
  ...
  { 
    ...
    try
    {
      BufferedReader br=new BufferedReader(new FileReader("Birthday"));
