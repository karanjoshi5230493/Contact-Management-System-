...
//SearchBirthdayForm searches birthday entry month wise.
public class SearchBirthdayForm extends JFrame implements ActionListener
{
  ...
  public SearchBirthdayForm(String fname)
  {
    super(fname);
    Vector v=new Vector();
